...
//            buildQueue.add(new Entity(-1, getMyId(), EntityType.HOUSE, new Coordinate(11+i*3, 4), 0, false));
//            buildQueue.add(new Entity(-1, getMyId(), EntityType.HOUSE, new Coordinate(4, 12+i*3), 0, false));
        }
*/
/*
