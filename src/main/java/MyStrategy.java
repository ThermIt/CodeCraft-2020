...
public class MyStrategy implements Strategy {
    ...
    public Action getAction(PlayerView playerView, DebugInterface debugInterface) {
        ...
        for (Entity entity : playerView.getEntities()) {
            ...
            if (properties.isCanMove()) {
                ...
                buildAction = getBuildAction(playerView, myId, entity, properties, buildAction);
            }
    ...
    private BuildAction getBuildAction(PlayerView playerView, int myId, Entity entity, EntityProperties properties, BuildAction buildAction) {
